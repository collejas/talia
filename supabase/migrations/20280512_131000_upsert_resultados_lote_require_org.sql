...
-- Evita fallos opacos de RLS: la RPC de resultados/apariciones requiere
-- un tenant explícito antes de intentar escribir en tablas multi-tenant.
...
begin
    ...
    updated_existing AS (
        ...
        RETURNING r.id, r.dedupe_key, r.first_seen_at, r.last_seen_at, r.appearances_count, r.external_id, r.raw
    ),
    inserted_new AS (
