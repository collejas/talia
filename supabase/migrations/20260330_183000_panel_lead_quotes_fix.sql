...
BEGIN
    ...
    WHERE public.lead_tarjetas.id = p_tarjeta_id
    FOR UPDATE;
...
BEGIN
    ...
    WHERE public.lead_cotizaciones.id = p_quote_id
    FOR UPDATE;
    ...
    INTO v_lead
    FROM public.lead_tarjetas
    WHERE public.lead_tarjetas.id = v_quote.tarjeta_id
    FOR UPDATE;
    ...
    IF p_estado = 'enviada' THEN
        ...
        WHERE public.lead_tarjetas.id = v_lead.id;
    END IF;
