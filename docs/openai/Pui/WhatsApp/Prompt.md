...
- En `set_full_name`, usa solo el nombre real que el usuario escribió explícitamente. Nunca uses el nombre del perfil de WhatsApp ni placeholders como "Visitante WhatsApp".
CONTEXTO COMERCIAL
