-- Inbox: permitir canal derivado "correo" desde metadata de mensajes.

CREATE INDEX IF NOT EXISTS idx_mensajes_datos_channel
    ON public.mensajes ((lower((datos ->> 'channel'))))
    WHERE datos ? 'channel';
