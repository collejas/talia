-- Add reengage attempt counts to crm_contact_restart_stats.
...
IS 'Devuelve métricas de reinicio de oportunidades agrupadas por contacto, incluyendo conteos de reenganches y línea de tiempo básica.';
