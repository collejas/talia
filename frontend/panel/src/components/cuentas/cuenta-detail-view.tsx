...
function buildDraftFromDirectionRow(row: Record<string, unknown>, keyFallback: string): AccountDirectionDraft {
  ...
  return createEmptyDirectionDraft({
    ...
    colonia: readDirectionText(direction?.colonia),
...
export function CuentaDetailView({ cuentaId }: { cuentaId: string }) {
  ...
  const openEditDialog = () => {
    ...
    setEditForm({
      ...
      pais: getInputText(preferredDirection?.pais),
      clave_entidad: getInputText(preferredDirection?.clave_entidad),
      entidad: getInputText(preferredDirection?.entidad),
      clave_municipio: getInputText(preferredDirection?.clave_municipio),
      municipio: getInputText(preferredDirection?.municipio),
      localidad: getInputText(preferredDirection?.localidad),
      clave_localidad: getInputText(preferredDirection?.clave_localidad),
      tipo_vialidad: getInputText(preferredDirection?.tipo_vialidad),
      nombre_vialidad: getInputText(preferredDirection?.nombre_vialidad),
      numero_exterior: getInputText(preferredDirection?.numero_exterior),
      letra_exterior: getInputText(preferredDirection?.letra_exterior),
      numero_interior: getInputText(preferredDirection?.numero_interior),
      letra_interior: getInputText(preferredDirection?.letra_interior),
      ...
      colonia: getInputText(preferredDirection?.colonia),
      ...
      codigo_postal: getInputText(preferredDirection?.codigo_postal),
