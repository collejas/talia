...
\restrict IkNVMPX340kF44tiHc4xoZWHbnGrVjxqCn160V0GhQgGUJfcTLFKutjK3Qc0rA2
...
--
-- Name: logos logos_write_admin; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY logos_write_admin ON public.logos TO authenticated USING (public.es_admin(auth.uid())) WITH CHECK (public.es_admin(auth.uid()));
...
\unrestrict IkNVMPX340kF44tiHc4xoZWHbnGrVjxqCn160V0GhQgGUJfcTLFKutjK3Qc0rA2
