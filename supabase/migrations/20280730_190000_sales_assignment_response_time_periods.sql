...
REVOKE ALL ON FUNCTION public.crm_asignaciones_vendedores_tiempos_resumen(uuid, timestamptz, timestamptz) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.crm_asignaciones_vendedores_tiempos_resumen(uuid, timestamptz, timestamptz) TO service_role;
