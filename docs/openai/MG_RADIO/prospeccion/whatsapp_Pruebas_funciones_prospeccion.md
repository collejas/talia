{
  "name": "set_full_name",
  "description": "Guardar o actualizar el nombre completo del contacto asociado a esta conversación de prospección de MG Radio.",
  "strict": true,
  "parameters": {
    "type": "object",
    "properties": {
...
{
  "name": "set_email",
  "description": "Guardar o actualizar el correo electrónico del lead de prospección.",
  "strict": true,
  "parameters": {
    "type": "object",
    "properties": {
...

{
  ...
  "description": "Guardar contexto comercial de la prospección para MG Radio.",
  "strict": true,
  "parameters": {
    "type": "object",
    "properties": {
