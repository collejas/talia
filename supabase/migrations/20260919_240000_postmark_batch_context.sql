...
-- Devuelve el contexto transitorio necesario para preparar un lote Postmark.
-- La estructura de negocio continúa en sus tablas; el JSONB sólo transporta
-- el resultado combinado entre el worker y Supabase.
...
COMMENT ON FUNCTION public.worker_get_postmark_batch_context IS
    'Carga en una operación el contexto de preparación Postmark de un lote por tenant.';
