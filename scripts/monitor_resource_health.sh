...
MEM_AVAILABLE_MIN_MB="${MEM_AVAILABLE_MIN_MB:-900}"
SWAP_USED_MAX_MB="${SWAP_USED_MAX_MB:-256}"
DISK_USED_MAX_PERCENT="${DISK_USED_MAX_PERCENT:-80}"
LOAD_PER_CPU_MAX="${LOAD_PER_CPU_MAX:-1.25}"
