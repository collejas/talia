...
-- Se elimina la versión previa (sin payload explícito) para evitar sobrecarga.
...
COMMENT ON FUNCTION public.registrar_mensaje_whatsapp(
    ...
    jsonb,
    jsonb
) IS 'Registra mensajes entrantes o salientes del canal WhatsApp, liga la carga cruda en webhooks_entrantes y gestiona la conversación asociada.';
