...
-- La RPC de round-robin se usa desde procesos internos con service role.
-- No debe quedar ejecutable por clientes autenticados directamente.
...
comment on function public.asignar_vendedor_round_robin(uuid) is
    'Selecciona al siguiente vendedor de forma round-robin y actualiza su timestamp. Solo service_role.';
