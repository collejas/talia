...
3. Ajustar frontend (drawer, modal, badges, métricas) para consumir los endpoints nuevos.
4. QA en staging de todo el flujo demo → cotización → negociación.
5. Documentar en `README`/playbooks cómo crear y enviar cotizaciones.
