...
- Queda pendiente mantener el log de la API `/crm/ventas/logs` sincronizado con los pasos de la venta y, si queremos, anexar ahí los eventos que ya se escriben en `propiedades-ventas.log` para tener duplicación de auditoría en el frontend 3D.
