  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <CardTitle className="text-base font-semibold">Rendimiento de campañas</CardTitle>
            <p className="text-sm text-muted-foreground">Consulta envíos, aperturas, clics y conversiones en el tablero global.</p>
          </div>
          <a className="text-sm text-primary underline-offset-4 hover:underline" href="/prospeccion/metricas">
