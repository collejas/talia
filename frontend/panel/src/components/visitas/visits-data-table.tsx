...
const VISIT_FIELDS: VisitField[] = [
  { id: "session_id", key: "session_id", label: "Sesión", type: "code" },
  ...
  { id: "avg_stay_seconds", key: "avg_stay_seconds", label: "Estancia promedio (s)", type: "number" },
  { id: "visit_count", key: "visit_count", label: "Visitas", type: "number" },
  { id: "total_visitas", key: "total_visitas", label: "Visitas totales", type: "number" },
  { id: "tuvo_chat", key: "tuvo_chat", label: "Tuvo chat", type: "boolean" },
  ...
  { id: "contacto_nombre", key: "contacto_nombre", label: "Contacto nombre", type: "string" },
  { id: "contacto_correo", key: "contacto_correo", label: "Contacto correo", type: "string" },
