          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                ...
                <strong> catalog_items</strong> y el resto de columnas va a <strong>metadata</strong>.
              </p>
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                línea, familia, modelo y los campos adicionales.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p>
                ...
                <strong> nombre</strong>, la línea debe existir en el catálogo, las columnas extra se convertirá
                en metadata.
              </p>
            </div>
            <div className="space-y-2">
