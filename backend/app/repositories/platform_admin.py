...
class PlatformRepository:
    ...
    async def get_tenant_onboarding_progress(self, *, organizacion_id: UUID) -> dict[str, Any] | None:
        data = await self._rest(
            ...
            params={
                "select": "id,organizacion_id,webchat_decision,voz_decision,zoom_decision,web_tracking_decision,ultimo_paso,ultimo_paso_actualizado_en,actualizado_por,creado_en,actualizado_en",
                "organizacion_id": f"eq.{organizacion_id}",
                "limit": "1",
            },
        )
