...
- Se agregó el módulo de `Planes comerciales` en `settings/commercial-plans` para administrar planes, precios y entitlements comerciales desde el panel.
...
- El CRUD de planes, precios y entitlements ya quedó disponible para `platform admin` con alta, edición y desactivación lógica.
