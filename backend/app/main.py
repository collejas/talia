...
from app.api.routes.email_service import admin_router as email_service_admin_router
from app.api.routes.email_service import router as email_service_router
...
from app.services.opportunity_followup_jobs import opportunity_followup_state_runner
...
async def app_lifespan(_: FastAPI):
    ...
    try:
        ...
        shutdown_coroutines = [
            ...
            _shutdown_with_timeout(
                name="opportunity_followup_state_runner",
                coro=opportunity_followup_state_runner.shutdown(),
            ),
            _shutdown_with_timeout(
...
def create_app() -> FastAPI:
    ...
    app.include_router(email_service_admin_router)
