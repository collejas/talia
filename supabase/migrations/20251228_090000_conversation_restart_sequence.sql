-- Indica el número de reinicios directamente en la tabla de conversaciones y actualiza la vista del inbox.

ALTER TABLE public.conversaciones
    ADD COLUMN IF NOT EXISTS restart_sequence integer NOT NULL DEFAULT 1;

UPDATE public.conversaciones
SET restart_sequence = COALESCE(restart_sequence, 1);
